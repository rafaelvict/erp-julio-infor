...
public class Produto extends GenericDomain implements Serializable{
	...
	private Cst cstPisCofinsEntrada;
	
	@JsonIgnore
	@ManyToOne
	@JoinColumn(name = "cstPisCofins_saida")
	private Cst cstPisCofinsSaida;
	...
	public Produto(String descricao, String codBarra, String codBarra2, String codBarra3, Float precoEntrada,
			Float precoCusto, Float mgVar, Float precoVar, Float mgAtac1, Float precoAtac1, Float mgAtac2,
			Float precoAtac2, boolean ff, Integer estMin, Integer estMax, TipoLcm lcm, Integer desconto, Integer ipi,
			Integer txFin, Integer frete, String abc, Integer txImport, String descEstiq, boolean descEmp,
			...
			Integer valorAdc, Integer pesoLiq, Integer pesoBruto, boolean bloqDesc, boolean vidaLink, Integer descontoEmp, String registroMs, boolean servico,
			...
			String classFiscal, TipoIndicadorArredTrunc indArredTrunc, TipoIndicadorPropTerc indPropTerc, Integer aliqSubst, Integer dcb,
		...
		this.estMin = estMin;
		this.estMax = estMax;
		this.lcm = (lcm==null) ? null : lcm.getCodigo();
		...
		this.indArredTrunc = (indArredTrunc==null) ? null : indArredTrunc.getCodigo();
		this.indPropTerc = (indPropTerc==null) ? null : indPropTerc.getCodigo();
	...
	public TipoLcm getLcm() {
		return TipoLcm.toEnum(lcm);
	}

	public void setLcm(TipoLcm lcm) {
		this.lcm = lcm.getCodigo();
	}
	...
	public TipoIndicadorArredTrunc isIndArredTrunc() {
		return TipoIndicadorArredTrunc.toEnum(indArredTrunc);
	}

	public void setIndArredTrunc(TipoIndicadorArredTrunc indArredTrunc) {
		this.indArredTrunc = indArredTrunc.getCodigo();
	}

	public TipoIndicadorPropTerc isIndPropTerc() {
		return TipoIndicadorPropTerc.toEnum(indPropTerc);
	}

	public void setIndPropTerc(TipoIndicadorPropTerc indPropTerc) {
		this.indPropTerc = indPropTerc.getCodigo();
	}
	...
	public Cst getCstPisCofinsEntrada() {
		return cstPisCofinsEntrada;
	}

	public void setCstPisCofinsEntrada(Cst cstPisCofinsEntrada) {
		this.cstPisCofinsEntrada = cstPisCofinsEntrada;
	}

	public Cst getCstPisCofinsSaida() {
