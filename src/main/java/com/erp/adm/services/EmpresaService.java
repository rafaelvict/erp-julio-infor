...
public class EmpresaService {
	...
	public Empresa fromDTO(EmpresaNewDTO objDTO) {
		...
		Endereco end = new Endereco(objDTO.getRua(), objDTO.getNumero(), objDTO.getBairro(), objDTO.getComplemento(), objDTO.getCep(), TipoEndereco.toEnum(objDTO.getTipo_End()), cid.get(), emp, null, null, null, null, null, null);
		Telefone tel = new Telefone(objDTO.getDdd(), objDTO.getTelefone(), TipoTelefone.toEnum(objDTO.getTipo_tel()),objDTO.getDataAltera(), emp, null, null, null, null, null, null);
