...
public class FuncionarioService { 
	...
	public Funcionario fromDTO(FuncionarioNewDTO objDTO) {
		...
		Endereco end = new Endereco(objDTO.getRua(), objDTO.getNumero(), objDTO.getBairro(), objDTO.getComplemento(), objDTO.getCep(), TipoEndereco.toEnum(objDTO.getTipo_End()), cid.get(), null, func, null, null, null, null, null);
		Telefone tel = new Telefone(objDTO.getDdd(), objDTO.getTelefone(), TipoTelefone.toEnum(objDTO.getTipo_Tel()), objDTO.getData_altera(), null, func, null, null, null, null, null);
